...
export default function MarketsPreferencesPage() {
  ...
  const loadData = async () => {
    try {
      ...
      // Load available markets and user preferences
  ...
  const getStatusBadge = (status: string) => {
    const statusConfig = {
      ...
      beta: { label: 'Beta', className: 'bg-yellow-100 text-yellow-700' },
    ...
    <div className="max-w-6xl mx-auto p-6 space-y-8">
      ...
      <div>
        ...
        <p className="text-gray-600 mt-2">
          Select which markets you want to track for market research and analytics
        </p>
      </div>
