...
#### API Endpoints
- [ ] Create preferences.routes.ts
  - [ ] POST /api/preferences (create/update)
  - [ ] GET /api/preferences (retrieve)
  - [ ] DELETE /api/preferences (clear)
- [ ] Create extractions.routes.ts
...
- [ ] Create maps.routes.ts
  - [ ] GET /api/maps (list)
  - [ ] POST /api/maps (create)
  - [ ] GET /api/maps/:id (details)
  - [ ] PUT /api/maps/:id (update)
  - [ ] DELETE /api/maps/:id (delete)
- [ ] Create pins.routes.ts
  - [ ] GET /api/maps/:id/pins (list)
  - [ ] POST /api/maps/:id/pins (create)
  - [ ] PUT /api/maps/:id/pins/:pin_id (update)
  - [ ] DELETE /api/maps/:id/pins/:pin_id (delete)
...
**Backend Track Status:** ⏳ 0/47 tasks complete
...
**Last Updated:** February 2, 2026 at 2:52 PM EST  
**Updated By:** Claude (RocketMan)  
**Status:** All planning complete, awaiting parallel development to begin
