...
export function F3PortfolioEvents() {
  ...
  return (
    <div className="min-h-screen font-mono p-4" style={{ backgroundColor: '#0B0E1A', color: '#E2E8F0' }}>
        ...
        <div className="flex justify-between items-end mb-4">
          <div>
            <h1 className="text-2xl font-bold tracking-wider mb-1" style={{ color: '#E2E8F0' }}>
              F3 PORTFOLIO — EVENT INTELLIGENCE
            </h1>
            <p className="text-sm" style={{ color: '#A0ABBE' }}>
              12 tracked assets | 5 active MSAs | 23 live events
            </p>
          </div>
      ...
      {/* TOP SECTION: KPI PILLS */}
      <div className="flex gap-4 mb-6">
        <div className="flex-1 p-3 rounded flex items-center gap-3 border" style={{ backgroundColor: '#131929', borderColor: '#1E2538' }}>
          <Activity size={18} style={{ color: '#0891B2' }} />
          <div>
            <div className="text-xs uppercase" style={{ color: '#6B7A8D' }}>Active Events</div>
        ...
        <div className="flex-1 p-3 rounded flex items-center gap-3 border" style={{ backgroundColor: '#131929', borderColor: '#1E2538' }}>
          ...
          <div>
            <div className="text-xs uppercase" style={{ color: '#6B7A8D' }}>Divergence Alerts</div>
            <div className="text-lg font-bold" style={{ color: '#EF4444' }}>3</div>
          </div>
        </div>
        <div className="flex-1 p-3 rounded flex items-center gap-3 border" style={{ backgroundColor: '#131929', borderColor: '#1E2538' }}>
          <Calendar size={18} style={{ color: '#D97706' }} />
          <div>
            <div className="text-xs uppercase" style={{ color: '#6B7A8D' }}>Next 90 Days</div>
            <div className="text-lg font-bold">7 Materializing</div>
          </div>
        </div>
        <div className="flex-1 p-3 rounded flex items-center gap-3 border" style={{ backgroundColor: '#131929', borderColor: '#1E2538' }}>
          <TrendingUp size={18} style={{ color: '#10B981' }} />
          <div>
            <div className="text-xs uppercase" style={{ color: '#6B7A8D' }}>Avg IRR Uplift</div>
            <div className="text-lg font-bold" style={{ color: '#10B981' }}>+1.4pp</div>
          </div>
        </div>
      </div>
