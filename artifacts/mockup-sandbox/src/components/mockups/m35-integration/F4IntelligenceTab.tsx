...
import { Megaphone, Train, FileText, Building2, CircleDollarSign, BarChart3, ChevronDown, ArrowRight, Activity, TrendingUp } from 'lucide-react';
    ...
    <div className="w-full min-h-screen bg-[#0B0E1A] text-[#E2E8F0] p-6 font-sans flex flex-col gap-6 overflow-auto">
      ...
      <section className="flex flex-col gap-3">
        ...
        <div className="flex justify-between items-center">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-[#0891B2] text-[11px] font-bold tracking-widest uppercase">Structured Events</h2>
          </div>
          <div className="text-[#6B7A8D] text-xs font-mono">
      ...
      <section className="flex flex-col gap-4 mt-2">
        ...
        <div className="flex items-center w-full">
          <div className="text-[11px] font-mono text-[#6B7A8D] whitespace-nowrap">── RAW INTELLIGENCE FEED </div>
