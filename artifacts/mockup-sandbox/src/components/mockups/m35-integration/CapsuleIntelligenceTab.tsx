...
import { Megaphone, Train, ScrollText, TrendingUp, AlertTriangle, ArrowRight, Activity, Building, DollarSign, ChevronDown, ChevronRight, ChevronUp } from 'lucide-react';
    ...
    <div className="w-full min-h-screen bg-[#0B0E1A] text-[#E2E8F0] p-4 font-mono flex flex-col gap-6 selection:bg-[#0891B2] selection:text-white">
      ...
      <div className="flex flex-col gap-1">
        <div className="text-[#6B7A8D] text-xs">
          3820 W Kennedy Blvd, Tampa FL
        </div>
        <h1 className="text-xl font-semibold tracking-wide uppercase text-[#E2E8F0]">
      ...
      {/* COLLAPSIBLE SUBSECTION — EVENTS AFFECTING THIS DEAL */}
      <section className="flex flex-col border border-[#1E2538] rounded overflow-hidden mt-2">
        {/* Header bar (always visible) */}
        <div 
          onClick={() => setEventsExpanded(!eventsExpanded)}
          className="h-12 bg-[#131929] border-l-2 border-l-[#0891B2] flex items-center justify-between px-4 cursor-pointer hover:bg-[#1E2538]/50 transition-colors relative overflow-hidden"
          style={{ boxShadow: 'inset 0 0 20px rgba(217, 119, 6, 0.05)' }}
        >
          ...
          <div className="flex items-center gap-2 text-[10px]">
            <span className="px-2 py-1 bg-[#1E2538] text-[#A0ABBE] rounded border border-[#6B7A8D]/30">1 FIRED</span>
            <span className="px-2 py-1 bg-[#1E2538] text-[#A0ABBE] rounded border border-[#6B7A8D]/30">2 PENDING</span>
            <span className="px-2 py-1 bg-[#1E2538] text-[#E2E8F0] rounded border border-[#6B7A8D]/30">42% OF IRR FROM EVENTS</span>
          </div>

          <div className="flex items-center gap-4">
            <div className="flex items-center gap-1 px-2 py-1 bg-[#EF4444]/10 text-[#EF4444] text-[10px] rounded border border-[#EF4444]/30 font-semibold">
              EVENT SENSITIVITY: HIGH <AlertTriangle size={10} />
            </div>
            <div className="text-[#0891B2] text-xs flex items-center gap-1 hover:text-[#22D3EE]">
        ...
        {/* Collapsible Content */}
        {eventsExpanded && (
          <div className="p-4 bg-[#0B0E1A] flex flex-col gap-4 border-t border-[#1E2538]">
            {/* EventTimelineChart */}
