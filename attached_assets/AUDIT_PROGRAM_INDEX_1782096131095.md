...
*No audit below has been run yet — the dispatches exist; the reports do not. Written ≠ run ≠ triaged.*

| # | Audit | Axis | Gating? | Status | Dispatch file |
|---|---|---|---|---|---|
| A1 | Plumbing & Invariants | horizontal (shared infra) | **LAUNCH** (the [LAUNCH]-tagged subset) | ◑ | `AUDIT_DISPATCH_PLUMBING_AND_INVARIANTS.md` |
| A2 | S1 Chat Launch Chain (+ failure-mode) | vertical (revenue path) | **LAUNCH** | ◑ | `AUDIT_DISPATCH_S1_CHAT_LAUNCH_CHAIN.md` |
...
| A5 | Billing / Tier / Automation-Level Gating | wiring (monetization) | **LAUNCH** | ● | `AUDIT_DISPATCH_A5_BILLING_TIER_AUTOMATION.md` |
