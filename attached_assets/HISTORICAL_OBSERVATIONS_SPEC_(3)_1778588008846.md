...
| **2 — Property performance → corpus** | Transformer from existing parser output → corpus rows; backfill historical uploads for the three subject properties (Jacksonville 2018+, Atlanta #1 2020+, Atlanta #2 2022+) — **INFERRED-NOT-VERIFIED at time of writing; see correction below** | Phase 1 schema | 1 sprint |

> **Correction (2026-05-31):** The "three subject properties" referenced above as "Jacksonville 2018+, Atlanta #1 2020+, Atlanta #2 2022+" were session-memory claims that were NOT verified against live data at the time this document was written. Live SQL audit (2026-05-31) verified the actual owned portfolio as: Frisco TX (4800 Spring Creek Pkwy, manual data, Jul 2024–Dec 2025), McKinney TX (1200 Eldorado Pkwy, manual data, Jul 2024–Dec 2025), Duluth GA (2789 Satellite Blvd, Gwinnett County, Yardi data, Dec 2021–Dec 2022). No Jacksonville. No Atlanta Midtown. Phase 2 backfill scope should reference the verified three properties, not the session-memory claims. See `docs/operations/OWNED_PORTFOLIO_AND_CORRELATION_ENGINE_MAP.md` §1.3 for the authoritative list.
