...
> **Correction (2026-05-31):** This document was the audit prompt that triggered the owned/portfolio + correlation engine verification. The portfolio composition stated in this prompt ("Jacksonville (2018+), Atlanta property A (2020+), Atlanta property B (2022+)") was the session-memory claim being investigated — it is **INFERRED-NOT-VERIFIED** and has since been disproved. The audit produced by this prompt (`docs/operations/OWNED_PORTFOLIO_AND_CORRELATION_ENGINE_MAP.md`) verified via live SQL that the actual owned portfolio is: Frisco TX (4800 Spring Creek Pkwy, manual data, Jul 2024–Dec 2025, 94.7% occ), McKinney TX (1200 Eldorado Pkwy, manual data, Jul 2024–Dec 2025, 94.6% occ), Duluth GA (2789 Satellite Blvd, suburban Gwinnett, Yardi data, Dec 2021–Dec 2022, 95.0% occ). **No Jacksonville. No Atlanta Midtown.** All references to "Jacksonville (2018+)", "Atlanta property A (2020+)", "Atlanta property B (2022+)", and their variants in this document are the prior incorrect session-memory claims. Do not treat them as facts. See the audit output and `docs/architecture/ARCHITECTURE_RECONCILIATION.md` §6 (2026-05-31) for the verified state.
