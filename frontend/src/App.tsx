...
const ArchiveUploadPage = lazy(() => import('./pages/ArchiveUploadPage'));
  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path="/archive/upload" element={<Suspense fallback={<PageLoadingFallback />}><ArchiveUploadPage /></Suspense>} />
