...
const AIRenderingPanel: React.FC<any> = () => (
  <div style={{ background: '#050810', minHeight: '100%', padding: 20 }}>
    <div style={{ fontSize: 11, fontWeight: 700, color: '#c77dff', letterSpacing: 2, textTransform: 'uppercase', fontFamily: 'monospace', marginBottom: 12 }}>AI Rendering Panel</div>
