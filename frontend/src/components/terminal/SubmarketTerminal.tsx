...
import { SubmarketEventsTab } from './tabs/submarket/SubmarketEventsTab';
...
export const SUBMARKET_TABS = [
  ...
  { key: 'events', label: 'EVENTS', shortcut: '9' },
] as const;
...
export const SubmarketTerminal: React.FC<SubmarketTerminalProps> = ({
  ...
  useEffect(() => {
    ...
    loadSubmarket();
  // Task #425: useEffect intentionally omits `msaId`, `msaName`, and
  // `submarketName` — the omitted value(s) are either (a) stable references
