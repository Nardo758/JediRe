...
export function TerminalChrome({
  ...
  // Task #425: useEffect intentionally omits `theme` — the omitted value(s)
  ...
  // Task #425: useEffect intentionally omits `T — the omitted value(s) are
  // either (a) stable references from context/store hooks whose identity is
