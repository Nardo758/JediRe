...
const ClimateRiskPanel: React.FC<ClimateRiskPanelProps> = ({ tradeAreaId }) => {
  ...
  useEffect(() => {
    fetchClimateRisk();
  // hook intentionally omits fetchClimateRisk — it's an inline function recreated each render; including it would cause an infinite re-fetch loop. The function close over the listed primitive deps.
