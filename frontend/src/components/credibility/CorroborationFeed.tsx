...
export default function CorroborationFeed({ 
  ...
  // hook intentionally omits fetchCorroborations — it's an inline function recreated each render; including it would cause an infinite re-fetch loop. The function close over the listed primitive deps.
