...
export const PropertyBoundarySection: React.FC<PropertyBoundarySectionProps> = ({ 
  ...
  // Task #425: useEffect intentionally omits `deal? — the omitted value(s)
  ...
  // Task #425: useEffect intentionally omits `lookupZoning`, `zoningInfo`,
  // and `zoningLoading` — the omitted value(s) are either (a) stable
