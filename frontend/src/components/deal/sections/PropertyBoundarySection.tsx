...
export const PropertyBoundarySection: React.FC<PropertyBoundarySectionProps> = ({ 
  ...
  return (
    <div className="space-y-4">
        ...
        <div className="flex items-center justify-between">
          ...
          {hasBoundary && (
            <div className="flex items-center gap-2 text-sm">
              ...
              <span className="text-green-400 font-medium">Boundary Defined</span>
            </div>
          )}
        </div>
      )}
      ...
      {/* Error message */}
      {error && (
        <div className="bg-[#1c0a0a] border border-red-800/50 rounded-lg p-4 flex items-start gap-3">
      ...
      {geocodingAddress && (
        <div className="bg-[#0d1e3d] border border-blue-900/50 rounded-lg p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-blue-300 font-medium">Locating Site</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div className="lg:col-span-2 space-y-3">
          {/* Drawing Tools */}
          <div className="bg-[#0F1319] rounded-lg border border-[#1e2a3d] p-3">
          ...
          <div 
            ref={mapContainerRef}
            className="w-full h-[500px] rounded-lg border border-[#253347] shadow-sm"
          />

          {/* Layer Toggles */}
          <div className="bg-[#0F1319] rounded-lg border border-[#1e2a3d] p-3">
            <p className="text-sm font-medium text-[#9EA8B4] mb-2">Map Layers</p>
                ...
                <button
                  ...
                  className={`flex items-center gap-2 px-3 py-1.5 rounded-lg text-sm transition-colors ${
                    visible
                      ...
                      : 'bg-[#131920] text-[#9EA8B4] border border-[#1e2a3d]'
                  }`}
                >
          ...
          {/* Zoning Code Details */}
          {hasBoundary && (
            <div className="mt-4 bg-[#0F1319] rounded-lg border border-[#1e2a3d] p-4">
              <div className="flex items-center justify-between mb-3">
                <h3 className="text-sm font-semibold text-[#9EA8B4]">Zoning Code Details</h3>
                {dataSource && (
                  <span className={`inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-xs font-medium ${
                    dataSource === 'database' 
                      ? 'bg-[#022c22] text-green-300' 
                      : 'bg-[#1a0d3d] text-purple-800'
                  }`}>
                    {dataSource === 'database' ? (
              ...
              {zoningLoading ? (
                ...
                <div className="space-y-4">
                  {/* Current Code Header */}
                  <div className="bg-[#0d1e3d] rounded-lg p-3">
                    <div className="flex items-center justify-between mb-1">
                      <span className="text-lg font-bold text-blue-300">
                        {zoningDetail.zoning_code || zoningDetail.district_code}
                      </span>
                      <span className="text-xs bg-blue-200 text-blue-300 px-2 py-0.5 rounded-full">
                        {zoningDetail.category || 'Zoning District'}
                      </span>
                    </div>
                    <p className="text-sm text-blue-300">{zoningDetail.description || zoningDetail.district_name}</p>
                  ...
                  <div>
                    <p className="text-xs text-[#6B7585] uppercase tracking-wide mb-2">Development Standards</p>
                    <div className="grid grid-cols-2 gap-2 text-sm">
                      <div className="bg-[#0F1319] rounded p-2">
                      ...
                      <div className="bg-[#0F1319] rounded p-2">
                        ...
                        {zoningDetail.residential_far || zoningDetail.nonresidential_far ? (
                          <div>
                            <p className="font-semibold text-[#E8E6E1] text-sm">
                          ...
                          <p className="font-semibold text-[#E8E6E1]">{zoningDetail.max_far || '--'}</p>
                        )}
                      </div>
                      <div className="bg-[#0F1319] rounded p-2">
                      ...
                      <div className="bg-[#0F1319] rounded p-2">
                        ...
                        <p className="font-semibold text-[#E8E6E1]">{zoningDetail.max_stories || '--'}</p>
                      </div>
                      {(zoningDetail.max_lot_coverage != null || zoningDetail.max_lot_coverage_percent != null) && (() => {
                        ...
                        return (
                          <div className="bg-[#0F1319] rounded p-2">
                            <p className="text-xs text-[#6B7585]">Lot Coverage</p>
                            <p className="font-semibold text-[#E8E6E1]">{pct.toFixed(0)}%</p>
                          </div>
                        );
                      })()}
                      {zoningDetail.min_parking_per_unit != null && (
                        <div className="bg-[#0F1319] rounded p-2">
                          <p className="text-xs text-[#6B7585]">Parking Ratio</p>
                          <p className="font-semibold text-[#E8E6E1]">{zoningDetail.min_parking_per_unit} per unit</p>
                        </div>
                      )}
                    </div>
                  </div>
                  ...
                  {(zoningDetail.min_front_setback_ft != null || zoningDetail.setback_front_ft != null) && (
                    <div>
                      <p className="text-xs text-[#6B7585] uppercase tracking-wide mb-2">Required Setbacks</p>
                      <div className="grid grid-cols-3 gap-2 text-sm">
                        <div className="bg-[#0F1319] rounded p-2 text-center">
                          <p className="text-xs text-[#6B7585]">Front</p>
                          <p className="font-semibold">{zoningDetail.min_front_setback_ft ?? zoningDetail.setback_front_ft ?? '--'} ft</p>
                        </div>
                        <div className="bg-[#0F1319] rounded p-2 text-center">
                          <p className="text-xs text-[#6B7585]">Side</p>
                          <p className="font-semibold">{zoningDetail.min_side_setback_ft ?? zoningDetail.setback_side_ft ?? '--'} ft</p>
                        </div>
                        <div className="bg-[#0F1319] rounded p-2 text-center">
                          <p className="text-xs text-[#6B7585]">Rear</p>
                  ...
                  {zoningDetail.permitted_uses && zoningDetail.permitted_uses.length > 0 && (
                    <div>
                      <p className="text-xs text-[#6B7585] uppercase tracking-wide mb-2">Permitted Uses (By Right)</p>
                      <div className="flex flex-wrap gap-1.5">
                        {zoningDetail.permitted_uses.map((use: string, i: number) => (
                          <span key={i} className="inline-block px-2 py-0.5 bg-[#022c22] text-green-400 text-xs rounded-full border border-green-800/50">
                            {use.replace(/_/g, ' ')}
                          </span>
                        ))}
                      </div>
                  ...
                  {zoningDetail.conditional_uses && zoningDetail.conditional_uses.length > 0 && (
                    <div>
                      <p className="text-xs text-[#6B7585] uppercase tracking-wide mb-2">Conditional Uses</p>
                      <div className="flex flex-wrap gap-1.5">
                        {zoningDetail.conditional_uses.map((use: string, i: number) => (
                          <span key={i} className="inline-block px-2 py-0.5 bg-[#1a1200] text-yellow-700 text-xs rounded-full border border-yellow-200">
                            {use.replace(/_/g, ' ')}
                          </span>
                        ))}
                      </div>
        ...
        <div className="space-y-3">
          ...
          <div className="bg-[#0F1319] rounded-lg border border-[#1e2a3d] p-4">
            ...
            {/* Property Info */}
            <div className="mb-3 pb-3 border-b border-[#1e2a3d]">
              <p className="text-xs text-[#6B7585] uppercase tracking-wide mb-1">Property Address</p>
            ...
            {/* Municipality & Zoning */}
            <div className="mb-3 pb-3 border-b border-[#1e2a3d]">
              <p className="text-xs text-[#6B7585] uppercase tracking-wide mb-1">Municipality</p>
              {detectedLocation ? (
                <div className="mb-2">
                  <p className="text-sm font-medium text-[#E8E6E1]">{detectedLocation.city}, {detectedLocation.state}</p>
                  {detectedLocation.county && (
                    <p className="text-xs text-[#6B7585]">{detectedLocation.county}</p>
                  )}
                  {detectedLocation.hasZoningData ? (
                    <span className="inline-flex items-center mt-1 px-2 py-0.5 rounded-full text-xs font-medium bg-[#022c22] text-green-300">
              ...
              <p className="text-xs text-[#6B7585] uppercase tracking-wide mb-1 mt-2">Zoning Designation</p>
              {zoningLoading ? (
                <p className="text-sm text-gray-400 italic">Looking up zoning...</p>
              ) : zoningInfo ? (
                <div>
                  <p className="text-sm font-medium text-[#E8E6E1]">{zoningInfo.code}</p>
                  <p className="text-sm text-[#9EA8B4]">{zoningInfo.description}</p>
                  {parcelSource && (
            ...
            {/* Site Metrics */}
            <div className="mb-3 pb-3 border-b border-[#1e2a3d]">
              <p className="text-xs text-[#6B7585] uppercase tracking-wide mb-2">Site Metrics</p>
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  <span className="text-[#9EA8B4]">Parcel Area:</span>
                  <span className="font-medium text-[#E8E6E1]">
                    {formatNumber(boundary.parcelArea)} acres
                  </span>
                </div>
                <div className="flex justify-between">
                  <span className="text-[#9EA8B4]">Square Feet:</span>
                  <span className="font-medium text-[#E8E6E1]">
                    {formatNumber(boundary.parcelAreaSF, 0)} SF
                  </span>
                </div>
                <div className="flex justify-between">
                  <span className="text-[#9EA8B4]">Perimeter:</span>
                  <span className="font-medium text-[#E8E6E1]">
                ...
                {boundary.centroid && (
                  <div className="flex justify-between">
                    <span className="text-[#9EA8B4]">Centroid:</span>
                    <span className="font-medium text-[#E8E6E1] text-xs">
            ...
            {/* Buildable Summary */}
            <div>
              <p className="text-xs text-[#6B7585] uppercase tracking-wide mb-2">Buildable Area</p>
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  <span className="text-[#9EA8B4]">After Setbacks:</span>
                  <span className="font-medium text-[#E8E6E1]">
                ...
                <div className="flex justify-between">
                  <span className="text-[#9EA8B4]">Utilization:</span>
                  <span className="font-medium text-[#E8E6E1]">
                ...
                {zoningDetail && (zoningDetail.max_lot_coverage != null || zoningDetail.max_lot_coverage_percent != null) && (() => {
                  ...
                  return (
                    <>
                      <div className="flex justify-between">
                        <span className="text-[#9EA8B4]">Lot Coverage:</span>
                        <span className="font-medium text-[#E8E6E1]">{coveragePct.toFixed(0)}%</span>
                      </div>
                      {maxFootprint != null && (
                        <div className="flex justify-between">
                          <span className="text-[#9EA8B4]">Max Footprint:</span>
                          <span className="font-medium text-[#E8E6E1]">{maxFootprint.toLocaleString()} SF</span>
                        </div>
                      )}
                    </>
                  );
              ...
              {hasBoundary && boundary.buildablePercentage && boundary.buildablePercentage < 0.7 && (
                <div className="mt-2 p-2 bg-[#1a1200] rounded text-xs text-yellow-800">
          ...
          {/* Setbacks */}
          <div className="bg-[#0F1319] rounded-lg border border-[#1e2a3d] p-4">
            <h3 className="text-sm font-semibold text-[#9EA8B4] mb-3">Applied Setbacks</h3>
            {zoningDetail && (zoningDetail.min_front_setback_ft != null || zoningDetail.setback_front_ft != null) && (
              <p className="text-xs text-[#6B7585] mb-2">From {zoningDetail.zoning_code || zoningDetail.district_code} zoning code</p>
            )}
            <div className="space-y-2">
              {Object.entries(boundary.setbacks).map(([key, value]) => (
                <div key={key} className="flex justify-between items-center py-1.5 border-b border-[#1e2a3d] last:border-0">
                  <span className="text-sm text-[#9EA8B4] capitalize">{key} Setback</span>
                  <span className="text-sm font-semibold text-[#E8E6E1]">{value} ft</span>
                </div>
              ))}
            </div>
          </div>
