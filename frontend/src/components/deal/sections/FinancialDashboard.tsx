...
const FinancialDashboard: React.FC<any> = () => (
  <div style={{ background: '#050810', minHeight: '100%', padding: 20 }}>
    <div style={{ fontSize: 11, fontWeight: 700, color: '#f7b731', letterSpacing: 2, textTransform: 'uppercase', fontFamily: 'monospace', marginBottom: 12 }}>Financial Dashboard</div>
