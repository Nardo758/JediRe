...
export const BloombergOverviewSection: React.FC<BloombergOverviewSectionProps> = ({
  ...
  useEffect(() => {
    ...
    return () => { stopPolling?.(); };
  // Task #425: useEffect intentionally omits `loadActivity`,
  // `loadCapitalStack`, `loadJediScore`, `loadStrategy`, `loadTeam`, and
  // `loadUwEvidenceSummary` — the omitted value(s) are either (a) stable
