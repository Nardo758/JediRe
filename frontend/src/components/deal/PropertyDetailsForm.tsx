...
export const PropertyDetailsForm: React.FC<PropertyDetailsFormProps> = ({
  ...
  useEffect(() => {
    loadPropertyData();
  // hook intentionally omits loadPropertyData — it's an inline function recreated each render; including it would cause an infinite re-fetch loop. The function close over the listed primitive deps.
