...
const Page: React.FC = () => (
  <div style={{ padding: 32, background: '#0F1319', color: '#E8ECF1', fontFamily: "'JetBrains Mono',monospace", minHeight: '100vh' }}>
    ...
    <div style={{ fontSize: 18, color: '#00BCD4', fontWeight: 700, marginBottom: 8 }}>Bloomberg Markets</div>
    <div style={{ fontSize: 11, color: '#8B95A5' }}>Market intelligence landing hub.</div>
  </div>
);
