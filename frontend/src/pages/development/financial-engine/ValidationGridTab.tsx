...
const SOURCE_MAP: Record<string, string> = {
  ...
  broker:              'Broker OM',
  agent:               'Agent Derived',
  'agent:cashflow':    'Agent Derived',
  'agent:research':    'Agent Derived',
  'agent:zoning':      'Agent Derived',
  'agent:supply':      'Agent Derived',
  'agent:commentary':  'Agent Derived',
  platform:            'Platform Default',
  computed:            'Platform Computed',
  'engine:cashflow':   'Platform Computed',
...
export function ValidationGridTab(props: FinancialEngineTabProps) {
  ...
  // ── REVENUE ────────────────────────────────────────────────────────────────
  {
    ...
    rows.push({
      ...
      source:     rentGrPyo ?? (rawA?.source_type ? srcLabel(rawA.source_type) : 'Platform Benchmark'),
