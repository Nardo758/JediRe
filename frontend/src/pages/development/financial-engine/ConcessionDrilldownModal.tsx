...
export function ConcessionDrilldownModal({
  ...
  const total = view === 'recognized' ? recognizedAmount : earnedAmount;
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            <span style={{ fontSize: 9, color: MUTED, letterSpacing: 1 }}>CONCESSION DRILLDOWN</span>
            <span style={{ fontSize: 9, color: AMBER, fontWeight: 600, letterSpacing: 0.5 }}>
              {periodLabel}
            </span>
          </div>
          <button
          ...
          {view === 'earned' && (
            <div style={{ padding: '12px 14px', fontSize: 8, color: MUTED, lineHeight: 1.7 }}>
              <div style={{ marginBottom: 4, color: SEC }}>
                Earned concessions represent the cash value of concessions associated with lease
                events in this period (free rent, move-in allowances, etc.).
              </div>
              <div>
