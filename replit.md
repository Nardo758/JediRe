...
-   **Zoning & Entitlements Module:** A standalone page with six tabs for zoning lookup, entitlement tracking, development capacity analysis, regulatory risk assessment, zoning comparison, and time-to-shovel analysis. It includes an AI chat for contextual queries.
