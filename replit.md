...
-   **Owned portfolio composition — verified (2026-05-31):** The actual owned portfolio (verified by live SQL) is exactly three properties: **Frisco TX** (4800 Spring Creek Pkwy, manual data, Jul 2024–Dec 2025, 94.7% occ), **McKinney TX** (1200 Eldorado Pkwy, manual data, Jul 2024–Dec 2025, 94.6% occ), **Duluth GA** (2789 Satellite Blvd, Gwinnett County, Yardi data, Dec 2021–Dec 2022, 95.0% occ). There is **no Jacksonville property**, **no Atlanta Midtown property**, and **no data from 2018 or 2020**. Prior session memory claimed "Jacksonville 2018+, Atlanta A 2020+, Atlanta B 2022+" — this was incorrect. All three owned properties are observed at stabilized occupancy only; no lease-up trajectory data exists for any owned property. Source of truth: `docs/operations/OWNED_PORTFOLIO_AND_CORRELATION_ENGINE_MAP.md` §1.3.
