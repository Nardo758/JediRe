...
app.post('/api/v1/apartment-sync/pull', requireAuth, async (req: AuthenticatedRequest, res) => {
  try {
...
app.get('/api/v1/apartment-sync/status', requireAuth, async (req: AuthenticatedRequest, res) => {
  try {
...
app.get('/api/v1/apartment-sync/properties', requireAuth, async (req: AuthenticatedRequest, res) => {
  try {
...
app.get('/api/v1/apartment-sync/market-snapshots', requireAuth, async (req: AuthenticatedRequest, res) => {
  try {
...
app.get('/api/v1/apartment-sync/rent-comps', requireAuth, async (req: AuthenticatedRequest, res) => {
  try {
...
app.get('/api/v1/apartment-sync/supply-pipeline', requireAuth, async (req: AuthenticatedRequest, res) => {
  try {
    const { city = 'Atlanta', state = 'GA' } = req.query;
    const result = await pool.query(
