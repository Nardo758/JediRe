    ...
    try {
      ...
      return res.json({
        ...
        extracted: {
          ...
          zipCode:          prop?.zip ?? null,
          county:           prop?.county ?? null,
          msaName:          prop?.msaName ?? null,
          submarket:        e.marketComps?.submarketName ?? null,
          ...
          lotSizeAcres:     prop?.lotSizeAcres != null ? String(Number(prop.lotSizeAcres)) : null,
          parkingRatio:     prop?.parkingRatio != null ? String(Number(prop.parkingRatio)) : null,
          assetClass:       normalizeAssetClass(prop?.buildingClass ?? null),
