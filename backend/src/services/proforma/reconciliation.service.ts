 ...
 *
 * Re-base means: replace the old projected/gap values for the reconciled month
 * with the actual values, and optionally re-derive the forward projection from
 * the new baseline.
 */
