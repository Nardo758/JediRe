...
export const MODULE_REGISTRY: Record<ModuleId, ModuleDefinition> = {
  ...
  M07: {
    ...
    stage: 'S2: Market Intel',
    category: 'Intelligence',
    purpose: 'Physical + digital traffic → lease prediction. Drive-by counts, web visits, search volume.',
    hasAgent: false,
    outputs: [
  ...
  M08: {
    ...
    receivesFrom: [
      ...
      { moduleId: 'M07', dataKeys: ['traffic_trend', 'predicted_leases_week'], strength: 'optional' },
    ],
  ...
  M11: {
    ...
    stage: 'S3: Financial',
    category: 'Financial',
    purpose: 'Debt market conditions, lender matching, DSCR analysis, rate sensitivity.',
    hasAgent: false,
    outputs: [
      ...
      { key: 'lender_recommendations', type: 'array', description: 'Ranked lender list' },
    ],
    feedsInto: ['M09', 'M14'],
    receivesFrom: [
    ...
    buildStatus: 'Partial',
    priority: 'P1',
    uiLocation: 'Deal Capsule → Debt Tab',
  },
  ...
  M25: {
    ...
    receivesFrom: [
      ...
      { moduleId: 'M07', dataKeys: ['predicted_leases_week', 'traffic_trend'], strength: 'optional' },
