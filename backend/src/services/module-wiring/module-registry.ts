...
export const MODULE_REGISTRY: Record<ModuleId, ModuleDefinition> = {
  ...
  M07: {
    ...
    stage: 'S2: Market Intel',
    category: 'Intelligence',
    purpose: 'Physical + digital traffic → lease prediction. Drive-by counts, web visits, search volume, visibility scoring, comp traffic grid.',
    hasAgent: false,
    outputs: [
      ...
      { key: 'data_quality_score', type: 'score', unit: '0-4', description: 'Number of connected data sources' },
    ],
    feedsInto: ['M05', 'M08', 'M09', 'M14', 'M25'],
    receivesFrom: [],
    formulas: ['F28', 'F29'],
