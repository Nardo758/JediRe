...
Provide clear deal verdict: GO / CONDITIONAL GO / NO-GO with top 3 drivers.`,
    triggers: [
      ...
      { event: 'document_uploaded', conditions: { category: 't12' }, action: 'analyze', description: 'Refine underwriting with T12 actuals' },
      { event: 'document_uploaded', conditions: { category: 'rent roll' }, action: 'analyze', description: 'Refine underwriting with rent roll data' },
      { event: 'document_uploaded', conditions: { category: 'financial' }, action: 'analyze', description: 'Refine underwriting with financial analysis' },
    ],
    notificationChannels: ['in_app', 'email'],
    priority: 8,
    canWorkAutonomously: true,
