...
Provide specific dollar amounts and timelines. Flag tax deadlines proactively.`,
...

  {
    ...
    icon: 'Landmark',
    color: '#9B59B6',
    allowedSkills: ['query_deal_data', 'query_debt_market', 'run_refi_analysis', 'generate_report'],
...
Quote specific rate ranges and terms. Flag properties that may have financing challenges.`,
    triggers: [
      ...
      { event: 'deal_created', action: 'analyze', description: 'Initial debt sizing on new deals' },
    ],
    notificationChannels: ['in_app'],
    priority: 7,
    canWorkAutonomously: true,
...
Use precise legal terminology but explain implications in plain English.`,
...

  {
    ...
    icon: 'ShieldCheck',
    color: '#009688',
    allowedSkills: ['query_compliance_status', 'add_note', 'create_task', 'generate_report'],
...
Proactively flag expiring items. Create renewal tasks with lead time.`,
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    icon: 'Building',
    color: '#795548',
    allowedSkills: ['query_deal_data', 'run_return_analysis', 'add_note', 'create_task', 'generate_report'],
...
Provide specific dollar-impact estimates for recommendations.`,
    triggers: [
      { event: 'financials_updated', action: 'analyze', description: 'Analyze budget variance when financials uploaded' },
      { event: 'schedule_weekly', action: 'report', description: 'Weekly asset performance summary' },
    ],
    notificationChannels: ['in_app'],
    priority: 9,
    canWorkAutonomously: true,
...
Provide rent recommendations with comp support. Flag units priced significantly off-market.`,
    triggers: [
      ...
      { event: 'schedule_weekly', action: 'report', description: 'Weekly leasing velocity report' },
    ],
    notificationChannels: ['in_app'],
    priority: 11,
    canWorkAutonomously: true,
...
Estimate remaining useful life and replacement costs. Flag deferred maintenance risks.`,
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    icon: 'Handshake',
    color: '#00BCD4',
    allowedSkills: ['query_deal_data', 'search_market_data', 'run_return_analysis', 'add_note', 'generate_report'],
...
Model tax savings scenarios. Flag upcoming deadlines and elections.`,
    triggers: [
      { event: 'deal_status_changed', conditions: { status: 'loi' }, action: 'analyze', description: 'Structure analysis at LOI stage' },
...

  {
    ...
    icon: 'Search',
    color: '#00BCD4',
    allowedSkills: ['search_market_data', 'query_debt_market', 'add_note', 'generate_report'],
...
Synthesize data into actionable market views. Flag emerging risks and opportunities.`,
    triggers: [
      { event: 'news_alert', action: 'analyze', description: 'Analyze breaking news affecting markets' },
      { event: 'schedule_daily', action: 'report', description: 'Daily market intelligence brief' },
      { event: 'market_data_changed', action: 'alert', description: 'Alert on significant market changes' },
    ],
    notificationChannels: ['in_app', 'email'],
    priority: 17,
    canWorkAutonomously: true,
