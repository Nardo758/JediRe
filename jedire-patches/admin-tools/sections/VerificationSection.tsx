 ...
 * KYC, background checks, and AML compliance
 */
    ...
    <div style={{ padding: 24 }}>
      <div style={{ marginBottom: 24 }}>
        ...
        <p style={{ fontSize: 12, color: BT.text.secondary, fontFamily: MONO }}>
          Identity verification, background checks, and compliance
        </p>
      </div>
      ...
      <div style={{
        ...
        <p style={{ fontSize: 12, color: BT.text.secondary, fontFamily: MONO, maxWidth: 400, margin: '0 auto 24px' }}>
          Verify investors, run background checks, and ensure AML compliance for deal participants.
        </p>
        ...
        <div style={{ marginTop: 32, textAlign: 'left', maxWidth: 500, margin: '32px auto 0' }}>
          ...
          <ul style={{ fontSize: 11, color: BT.text.secondary, fontFamily: MONO, lineHeight: 2, paddingLeft: 20 }}>
            <li>KYC/KYB verification workflows</li>
            <li>Accredited investor verification</li>
            <li>Background check integration</li>
            <li>AML/OFAC screening</li>
            <li>Document collection (ID, proof of funds)</li>
